		...
		return(
				<div id="welcome" className="container">
					<div id="welcomeText">
						...
						<h3>This app was created so that anyone looking to create a garden could  utilize the benifits of companion planting.
						...
						Some plants are friends and some plants are not. Using this app you'll be able to determine which will work for you.</h3>
						<div id="signupBtn">
							<NavLink to="/login" > 
								Login/Signup 
							</NavLink>
